...
def app_basculas(filepath):
	...
	csvfile = path + "/output.csv"
	codfile = path + "/cod_barras.csv"
	dictionary_department = path + "/dictionary_department.csv"	#csv fams are dptments
	dictionary_fam = path + "/dictionary_fam.csv" 		#csv subfams are fams
	dictionary_subfam = path + "/dictionary_subfam.csv"
