...
# get stock
stock_path = "data/Products_Stocks.csv"
data_stock = get_stock(stock_path)

# 12 meses
online_path = "data/sales_online_12months.csv"
physical_path = "data/sales_physical_12months.csv"
months = 12
...
# 3 meses antes
online_path = "data/sales_online_3months_prior.csv"
physical_path = "data/sales_physical_3months_prior.csv"
months = 3
...
# 3 meses despues
online_path = "data/sales_online_3months_after.csv"
physical_path = "data/sales_physical_3months_after.csv"
months = 3
...
if os.path.exists('Salida/output.xlsx'):
	os.remove('Salida/output.xlsx')

writer = pd.ExcelWriter('Salida/output.xlsx')
